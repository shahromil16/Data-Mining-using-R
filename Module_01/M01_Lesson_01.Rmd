---
title: 'Module 01 Lesson 1: R Markdown'
...
In the first lesson, we start the module discussing R Markdown to create written reports with embedded working code. R Markdown is an authoring format that enables easy creation of dynamic documents, presentations, and reports from R. It combines the core syntax of markdown (an easy-to-write plain text format) with embedded R code chunks that are run so their output can be included in the final document. R Markdown documents can be regenerated whenever underlying R code or data changes.

This is an R Markdown document. Markdown is a simple formatting syntax for authoring HTML, PDF, and MS Word documents. For more details on using R Markdown see <http://rmarkdown.rstudio.com>.

In Module 01 Lesson 1 we will learn about R Markdown syntax. The following lessons and assingments all will use R Markdown.
...
![image R studio and Click on "Knit HTML"](http://54.88.34.236/YouTube/MachineLearning/M01/M01_A.png)
...
![image R Markdown Cheat Sheet (PDF)"](http://54.88.34.236/YouTube/MachineLearning/M01/M01_CS_A.png)
...
![image R Markdown Reference Guide (PDF)"](http://54.88.34.236/YouTube/MachineLearning/M01/M01_CS_B.png)

## Additional packages needed
 
To run the code in M01_Lesson_01.Rmd you may need additional packages.
...
![image R studio R Markdown Options"](http://54.88.34.236/YouTube/MachineLearning/M01/M01_A.png)


Options such as table of contents, using a CSS style sheet, etc.


![image R studio R Markdown Options"](http://54.88.34.236/YouTube/MachineLearning/M01/M01_D.png)
...
MS Word
![image R studio R Markdown Options MS Word"](http://54.88.34.236/YouTube/MachineLearning/M01/M01_E.png)

PDF
![image R studio R Markdown Options PDF"](http://54.88.34.236/YouTube/MachineLearning/M01/M01_C.png)


## Looading R libraries
```{r }
set.seed(333)
library(ggplot2)
library(lattice)
...
![image William Sealy Gosset, known as "Student", British statistician. Picture taken in 1908](http://54.88.34.236/YouTube/MachineLearning/M01/William_Sealy_Gosset_Student.jpg)
