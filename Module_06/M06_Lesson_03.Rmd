...
To run the code in M06_Lesson_03.Rmd you may need additional packages.
...
We will be using the dataset 'svm_regression.csv' which is randomly generated. [svm_regression.csv](http://nikbearbrown.com/YouTube/MachineLearning/M06/svm_regression.csv).  T

```{r}
data_url <- 'http://nikbearbrown.com/YouTube/MachineLearning/M06/svm_regression.csv'
...
![SVM](http://nikbearbrown.com/YouTube/MachineLearning/M06/SVM.png)  
*SVM*  
...
![Kernels](http://nikbearbrown.com/YouTube/MachineLearning/M06/Kernels.png)
...
![Kernels](http://nikbearbrown.com/YouTube/MachineLearning/M06/Kernels_1D_2D.png)
...
![Linear SVM](http://nikbearbrown.com/YouTube/MachineLearning/M06/Maximum_Margin_Classification_SVM.png)  
*Linear SVM*  
...
* [What are Kernels in Machine Learning and SVM?](https://www.quora.com/What-are-Kernels-in-Machine-Learning-and-SVM/answer/Nikhil-Garg)
