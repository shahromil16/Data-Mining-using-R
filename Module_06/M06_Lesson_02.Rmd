...
To run the code in M06_Lesson_02.Rmd you may need additional packages.
...
```{r data}
# Load our data
data_url <- 'http://nikbearbrown.com/YouTube/MachineLearning/M06/mushrooms.csv'
...
![decision tree play or n](http://nikbearbrown.com/YouTube/MachineLearning/M06/Decision_Trees_A.png)  
*Decision Tree*
