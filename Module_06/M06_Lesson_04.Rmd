...
To run the code in M06_Lesson_04.Rmd you may need additional packages.
...
![Linear Discriminants seperate groups](http://nikbearbrown.com/YouTube/MachineLearning/M04/Linear_Discriminant.png)  
